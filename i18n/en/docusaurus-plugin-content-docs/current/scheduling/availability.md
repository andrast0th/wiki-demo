...
- **With "next available provider"** using a shared clinic booking link, where DemoMed assigns the earliest matching slot across all providers who offer that appointment type.
