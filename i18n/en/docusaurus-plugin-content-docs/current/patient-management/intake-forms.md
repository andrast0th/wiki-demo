...
DemoMed ships with specialty-specific starter templates selected based on the specialty you set in your [clinic profile](/getting-started/clinic-profile). Dr. Osei's **Family Medicine** template includes:
