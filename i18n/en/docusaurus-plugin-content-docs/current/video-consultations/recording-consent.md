...
DemoMed allows visit recording for clinical documentation, training, or quality-assurance purposes — but only with explicit, logged patient consent, and recording is **off by default**.
