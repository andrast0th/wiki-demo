...
1. Go to **Today's Schedule** on your DemoMed dashboard.
...
Recording requires **verbal or written consent**, which DemoMed prompts for automatically — see [Recording & Consent](/video-consultations/recording-consent) for the full policy and how to configure it.
...
Either party can simply reopen the original visit link to rejoin — DemoMed rooms stay open for 30 minutes after the last participant disconnects. See [My video keeps freezing or dropping mid-visit](/faq/technical-faq#choppy-video) if drops happen repeatedly.
