...
- **Safari:** meniul Safari → Setări → Site-uri web → Cameră/Microfon → găsește domeniul SuperMed → setează pe „Permite”.
...
Aproape întotdeauna este o problemă de lățime de bandă, nu o pană a SuperMed. Încearcă, în ordine:
...
Dacă problemele persistă la mai multe vizite din aceeași locație, ar putea merita să verifici conexiunea de internet a cabinetului — recomandările minime de lățime de bandă ale SuperMed presupun că nicio altă utilizare intensă nu partajează aceeași conexiune în timpul vizitelor.

### Pot folosi SuperMed cu un al doilea monitor?

Da — nimic din SuperMed nu restricționează configurațiile cu mai multe monitoare. O configurație obișnuită este vizita video pe un ecran și fișa/notele clinice ale pacientului pe celălalt, deschise ca ferestre separate de browser.
...
Pacienții se pot alătura prin date mobile, dacă Wi-Fi nu este disponibil; Modul de lățime de bandă redusă al SuperMed (vezi mai sus) ajută semnificativ pe conexiuni mobile limitate. Momentan nu există o variantă de rezervă „apel telefonic doar-audio” — dacă un pacient chiar nu poate obține o conexiune video funcțională, vizita va trebui convertită într-un apel telefonic în afara SuperMed sau reprogramată.
