...
Vizitele video SuperMed rulează direct în browser (Chrome, Edge, Safari 16+ sau Firefox) folosind WebRTC — nu este nevoie de nicio aplicație separată, nici pentru medici, nici pentru pacienți.
...
Înainte de prima ta consultație, rulează verificarea încorporată a dispozitivelor din SuperMed:
