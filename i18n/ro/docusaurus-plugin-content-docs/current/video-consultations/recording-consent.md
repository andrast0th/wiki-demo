...
SuperMed permite înregistrarea vizitelor în scopuri de documentație clinică, instruire sau control al calității — dar numai cu consimțământul explicit și înregistrat al pacientului, iar înregistrarea este **dezactivată implicit**.
